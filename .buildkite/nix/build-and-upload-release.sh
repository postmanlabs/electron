...
buildAndUpload() {
  ...
  echo "--- Electron build"
  ninja -C out/Release electron -j 100
  ...
  ninja -C out/Release electron:electron_dist_zip -j 100
  ...
  ninja -C out/Release chrome/test/chromedriver -j 100
  [[ "$platform" == "linux" ]] && electron/script/strip-binaries.py --target-cpu="x64" --file $PWD/out/Release/chromedriver
  ninja -C out/Release electron:electron_chromedriver_zip -j 100

  echo "--- Build ffmpeg"
  gn gen out/ffmpeg --args="import(\"//electron/build/args/ffmpeg.gn\")"
  ninja -C out/ffmpeg electron:electron_ffmpeg_zip -j 100
  

  echo "--- Build mksnapshot"
  ninja -C out/Release electron:electron_mksnapshot -j 100
  ...
  ninja -C out/Release electron:electron_mksnapshot_zip -j 100
